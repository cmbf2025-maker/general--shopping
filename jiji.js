...
//<div class="share-backdrop" id="backdrop" onclick="closeShare()"></div>
  ...
  back_drop.onclick = function(){}
      ...
      let share_html = `
<!-- Sheet -->
<div class="share-sheet" id="sheet">
  ...
  <div class="apps-row">
    ...
    <button class="app-item" onclick="shareTo('WhatsApp')">
    ...
    <button class="app-item" onclick="shareTo('X (Twitter)')">
    ...
    <button class="app-item" onclick="shareTo('Facebook')">
    ...
    <button class="app-item" onclick="shareTo('Telegram')">
    ...
    <button class="app-item" onclick="shareTo('Instagram')">
    ...
    <button class="app-item" onclick="shareTo('LinkedIn')">
    ...
    <button class="app-item" onclick="shareTo('Reddit')">
    ...
    <button class="app-item" onclick="shareTo('Email')">
  ...
  <div class="action-list">
    ...
    <button class="action-item" onclick="shareTo('SMS')">
      <div class="action-icon">
    ...
    <button class="action-item" onclick="nativeShare()">
      <div class="action-icon">
